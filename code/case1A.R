...
cv_fun <- function(X, y, K=10){
  ...
  cv.out <- foreach(k = 1:K, .combine=rbind) %do% {
    ...
    it.ob <- c(nn1_mse,nn1_r2,nn2_mse,nn2_r2)
    names(it.ob) <- c("nn1_mse","nn1_r2",'nn2_mse','nn2_r2')
...
end_time - start_time
#
save(middle_zero,file = 'case1A_middle_0.Rdata')
#
load('case1A_middle_0.Rdata')
...
save(high_zero,file = 'case1A_high_0.Rdata')

load('case1A_high_0.Rdata')
# 
# high_zero
